...
export function InlineBubble({ direction, children, className }: BubbleProps) {
  return (
    <span
      className={cn(
        `relative rounded-3xl text-white px-3 py-px before:absolute after:absolute before:content-[''] after:content-[''] before:h-4 before:bottom-0 after:bottom-0 after:h-4 tracking-tight font-[550] inline-block mx-2`,
        direction === `right` &&
